...
class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=True):
        ...
        self.sa1 = PointNetSetAbstraction(npoint=512, radius=0.2, nsample=3, in_channel=in_channel, mlp=[64, 64, 128],
                                          group_all=False)
    ...
    def forward(self, xyz):
        B, _, _ = xyz.shape
        print("Initial input shape:", xyz.shape)
        ...
        print("After sa1:", l1_xyz.shape, l1_points.shape)  # Debug shapes after first abstraction
