...
class Pointnet2dataset(Dataset):
    def __init__(self, dataset_path, file_names, num_points=1024, augment=False):
        self.directory_path = '/home/aniruddha/PycharmProjects/Thesis_final/test_data'
        self.file_names =['AC_20150820_left.obj']
    ...
    dataset_path = '/home/aniruddha/PycharmProjects/Thesis_final/test_data'
